...
class MuZeroConfig:
    def __init__(self):
        ...
        # For each stock we can buy 10-100% of our buying power OR sell 10-100% of current amount invested (in increments of 10) or do nothing.
        ...
        # Max_moves = Trading days since 8/19/2004
        self.max_moves = 5984  # Maximum number of moves if game is not finished before
...
class Game(AbstractGame):
    ...
    def action_to_string(self, action_number):
        ...
        actions = {
            ...
            19: "Sold 90%",
            20: "Sold 100%",
            21: "Held Postion -- Did nothing"
        }
        return f"{action_number}. {actions[action_number]}"

class Stocks:
    def __init__(self, data):
        self.buyingPower = 5000
        self.numberOfStocks = 2
        self.day = 1
    ...
    def step(self, action):
        if action>=1 and action<=10:
            ...
            if self.buyingPower >= amountTryingToBuy:
                ...
                amountActuallyBought = numOfStocksBought * stockPrice
                self.buyingPower = self.buyingPower - amountActuallyBought
        ...
        if action>10 and action<=20:
            ...
            if numStockTryingToSell>0 and self.invested[self.stockLookedAt-1]>=numStockTryingToSell:
                ...
                self.buyingPower = self.buyingPower+stockPrice*numStockTryingToSell
        ...
        if self.stockLookedAt>=self.numberOfStocks:
            ...
            self.stockLookedAt = self.stockLookedAt + 1
